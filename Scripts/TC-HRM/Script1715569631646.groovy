...
WebUI.click(findTestObject('Page_OrangeHRM/Button arrow kiri'))

WebUI.verifyTextPresent('Dashboard', false)

WebUI.click(findTestObject('Page_OrangeHRM/a_Claim'))

WebUI.click(findTestObject('Page_OrangeHRM/button_Assign Claim'))
